...
async function main() {
  ...
  const demoHash = await bcrypt.hash("Demo123!ChangeMe", 12);
    ...
    create: {
      ...
      profile: {
        create: {
          ...
          lastName: "Mahouli",
          jobTitle: "Webmaster",
          company: "Mahouli Studio",
          bio: "J’accompagne les entreprises dans leur présence digitale.",
  ...
  // Création de la carte de démonstration
